...
WHERE (cod_prop NOT SIMILAR TO 'P1%|P6b|F1%|F2%|F5%|F6%|F7%|L%|R%|E%|S%|Z%'
	AND SPLIT_PART(nom_adresse,'|',1) SIMILAR TO '%BOURGEOISI%|% BOURGEOISE%|% SECTION %|SECTION %|% SECTION|SECTION|CONCORT %|
	% CONCORT %|% CONCORT|%CONSORTERI%|% CULTIF%|%PATECQ%|% PATUS %|PATUS %|% PATUS|PATUS|%QUEREUX%|
	%QUAIREU%|%QUERU %|QUERU %|% QUERU %|QUERU|% QUERU|%CARROUE%|%QUEIRIAU%|RAPE %|% RAPE %|% RAPE|RAPE|
